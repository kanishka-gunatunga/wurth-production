...
<div class="main-wrapper">
    ...
    <div class="row d-flex justify-content-between">
        ...
        <div class="col-lg-6 col-12 d-flex justify-content-lg-end gap-3 pe-5">
            <form id="searchForm" method="POST" action="{{ route('cheque_deposits.search') }}">
                @csrf
    ...
    <div class="styled-tab-main">
        ...
        @if(!empty($filters))
        <form method="POST" action="{{ route('cheque_deposits.export') }}">
...
<form method="POST" action="{{ route('cheque_deposits.filter') }}">
    @csrf
