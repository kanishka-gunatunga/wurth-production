            ...
            <div class="tab-content">
                ...
                <div id="customer-list" class="tab-pane fade show active" role="tabpanel"
                    ...
                    <div class="col-12 d-flex justify-content-end pe-5 mb-5">
                        <a href="{{url('finance/add-new-customer')}}">
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="sticky-column">
                                            <a href="{{url('finance/view-customer/'.$customer->id.'')}}"><button class="action-btn">View More</button></a>
                                            <a href="{{url('finance/edit-customer/'.$customer->id.'')}}"><button class="action-btn">Edit</button></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="sticky-column">
                                                    <a href="{{url('finance/edit-customer/'.$temp_customer->id.'')}}"><button class="action-btn">Edit</button></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
