                    ...
                    <div class="col-12 col-lg-6 col-md-6 import">
                        <div class="card main-card">
                            <div class="card-body ps-5">
                                ...
                                <div class="mb-4 ">
                                                <label for="head-of-division-select" class="form-label custom-input-label">Select Report Type</label>
                                                <select class="form-select custom-input" aria-label="Default select example" id="head-of-division-select" name="report_type">                            
                                                        <option value="sales">Sales Report</option>
                                                        <option value="credit">Credit Report Note</option>
                                                        <option value="extra-payment">Extra Payment Note</option>
                                                        <option value="return-cheques">Return Cheques Report</option>
                                                </select>
                                            </div>
                                <div class="card dotted-card" id="dropZone">
                                    ...
                                    <div class="card-body d-flex justify-content-center align-items-center">
                                            ...
                                            <div class="row">
                                                <input type="file" class="d-none" id="fileInput" name="report"  accept=".xls, .xlsx, .csv">
                                ...
                                @if($errors->has("report")) <div class="alert alert-danger mt-2">{{ $errors->first('report') }}</div>@endif
                            </div>
                        </div>
                    </div>
                </div>
