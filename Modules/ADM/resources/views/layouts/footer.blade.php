            ...
            <div class="d-flex flex-column justify-content-center align-items-center ">
                ...
                <div class="d-flex flex-column w-100 mb-3 justify-content-start">
                    ...
                    <div class="collapse" id="collapseReminder">
                        ...
                        <a href="{{ url('adm/notifications-and-reminders') }}" class="w-100 d-flex flex-row mb-3" style="text-decoration: none !important;"
                            class="d-flex flex-row align-items-center mt-2">
                            <div class="d-flex flex-row justify-content-center align-items-center">
                                <svg width="18" height="16" viewBox="0 0 18 16" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="{{ url('adm/notifications-and-reminders') }}" class="w-100 d-flex flex-row" style="text-decoration: none !important;"
                            class="d-flex flex-row align-items-center mt-2">
                            <div class="d-flex flex-row justify-content-center align-items-center">
                                <svg width="18" height="16" viewBox="0 0 18 16" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
