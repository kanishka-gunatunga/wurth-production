    ...
    <div class="dashboard-main-container">
        ...
        <div class="row gx-4 gy-3 dashboard-stats">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    <p class="stat-label">RSM's Count</p>
                    <h3 class="stat-number">{{ $rsmCount }} Regional Sales Managers</h3>
                </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-content">
                    <p class="stat-label">ASM's Count</p>
                    <h3 class="stat-number">{{ $asmCount }} Area Sales Managers</h3>
                </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-content">
                    <p class="stat-label">Team Leaders Count</p>
                    <h3 class="stat-number">{{ $tlCount }} Team Leaders</h3>
                </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-content">
                    <p class="stat-label">ADM's Count</p>
                    <h3 class="stat-number">{{ $admCount }} ADM's</h3>
                </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <h3 class="stat-number">{{ number_format(count($customers)) }} Customers</h3>
                </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-content">
                    @php
                        $currentMonthTotal = $currentMonthCollections->sum('amount') ?? 0;
                    @endphp
                    <p class="stat-label">Current Month Total Collection</p>
                    <h3 class="stat-number">LKR {{ number_format($currentMonthTotal) }}</h3>
                </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-content">
                    @php
                        $depositedTotal = $currentMonthCollections->where('status', 'deposited')->sum('amount'); // or 'paid_amount' if you track that
                    @endphp
                    <p class="stat-label">Current Month Accutal Collection Deposits</p>
                    <h3 class="stat-number">LKR {{ number_format($depositedTotal) }}</h3>
                </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-content">
                    @php
                        $onHandCash = $collections->where('status', 'pending')->where('type', 'cash')->sum('amount');
                    @endphp
                    <p class="stat-label">On Hand Cash</p>
                    <h3 class="stat-number">LKR {{ number_format($onHandCash) }}</h3>
                </div>
             ...
             <div class="stat-card">
                ...
                <div class="stat-content">
                     @php
                        $onHandCheques = $collections->where('status', 'pending')->where('type', 'cheque')->sum('amount');
                    @endphp
                    <p class="stat-label">On Hand Cheques</p>
                    <h3 class="stat-number">LKR {{ number_format($onHandCheques) }}</h3>
                </div>
        ...
        <!-- <div class="progress-section mt-4">
            ...
            <div class="progress-info">
                ...
                <span class="progress-values">LKR 1 / LKR 100</span>
            </div>
        ...
        <!-- <div class="performers-section mt-4">
            ...
            <div class="performer-item">
                ...
                <div class="performer-amount">LKR 100</div>
            </div>
        ...
        <!-- <div class="customers-section mt-4">
            ...
            <div class="customer-item">
                ...
                <div class="customer-amount">LKR 100</div>
            </div>
         ...
         <div class="row mt-4">
            ...
            <div class="col-md-6 ">
              <div class="section-card locked-users-card">
                <h3 class="section-title">Recently Assigned Users</h3>
            
                <div class="table-responsive division-table-sub mt-4">
                  ...
                  <table class="table">
                    ...
                    @empty
                          <tr>
                              <td colspan="3" class="text-center">No users registered this month.</td>
                          </tr>
                    @endforelse         
                    </tbody>
                  </table>
                   ...
                   <tbody>
                    @forelse($recentCustomers as $customer)
                        <tr>
                            ...
                            <td>
                               {{ $customer->admDetails->name ?? $customer->secondaryAdm->name ?? 'N/A' }} ({{ $customer->admDetails->adm_number ?? $customer->secondaryAdm->adm_number ?? 'N/A' }})
                            </td>
