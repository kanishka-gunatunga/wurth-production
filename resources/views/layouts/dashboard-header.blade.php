...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary w-100">
        <div class="container-fluid">
            <a class="navbar-brand" href="/"><img src="{{ asset('new-assets/images/wruth-logo.png') }}"
                    alt="" class="mb-0"></a>
            ...
            <nav id="sidebar" class="sidebar">
                        ...
                        <button class="sidebar-toggle border-0 bg-transparent" type="button" id="sidebarToggle">
                            <svg width="29" height="23" viewBox="0 0 29 23" fill="none"
                                ...
                                <path d="M26.9849 14.6908L6.47061 14.6908" stroke="#CC0000" stroke-width="2"
                                    stroke-linecap="round" />
                                <path d="M26.9849 21.5289H14.6763" stroke="#CC0000" stroke-width="2"
                                    stroke-linecap="round" />
                            </svg>
                        </button>
                    </div>
                ...
                <div class="sidebar-content">
                    <ul class="sidebar-list">
                                    ...
                                    <span class="me-4">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <path
                                                ...
                                                stroke="#090909" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                        </svg>
                                    ...
                                    <span class="me-4">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <path
                                                ...
                                                stroke-linejoin="round" />
                                            <path
                                                d="M16.1215 6.2425L18.2425 4.1215L16.1215 2M12 8.5V17M16 12V17M8 12V17"
                                                stroke="black" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                        </svg>
                        ...
                        @if (in_array('notifications', session('permissions')) ||
                        ...
                        @endif
                        @if (in_array('deposits', session('permissions')) ||
                                                    ...
                                                    <span class="me-4">
                                                        <svg width="24" height="24" viewBox="0 0 24 24"
                                                            ...
                                                            <path
                                                                ...
                                                                fill="white"
                                                                mask="url(#path-1-inside-1_2846_8184)" />
                                                        </svg>
                        ...
                        @if (in_array('security', session('permissions')) ||
