    ...
    <div class="invoice-box">
        ...
        <table class="details">
            <tr>
                ...
                <td><strong>Payment Type:</strong> Fund Transfer</td>
            ...
            <tr>
                <td><strong>Transfer Date:</strong> {{$payment->transfer_date}}</td>
                <td><strong>Transfer Reference Number:</strong> {{$payment->transfer_reference_number}}</td>
            </tr>
        </table>
