                ...
                <div class="p-4 pt-0">
                    ...
                    <div class="row d-flex justify-content-between">
                            ...
                            <div class="mb-4 col-12 col-lg-6">
                                ...
                                <input type="tel" class="form-control custom-input" id="division-input" placeholder="Mobile Number" name="mobile_number" value="{{old('mobile_number')}}" pattern="[0-9]{10}" maxlength="10">
                            ...
                            <div class="mb-4 col-12 col-lg-6">
                                ...
                                <input type="tel" class="form-control custom-input" id="division-input" placeholder="Secondary Mobile Number" name="secondary_mobile_number" value="{{old('secondary_mobile_number')}}" pattern="[0-9]{10}"  maxlength="10">
